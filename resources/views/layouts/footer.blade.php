<footer class="my-5 pt-5 text-muted text-center text-small">
    <p class="mb-1">© <?php echo date('Y'); ?> SQL Sentences Helper.</p>

    <ul class="list-inline">
      <li class="list-inline-item">All rights reserved diseñado por C3 Dev</li>
    </ul>
</footer>
...
<script type="text/javascript" src="{{ asset('datatable/js/dataTables.responsive.min.js') }}"></script>
